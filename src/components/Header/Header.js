    ...
    return (
        ...
        <div >
            ...
            <ReactBootStrap.Navbar collapseOnSelect expand="lg"  variant="light" bg="warning">
                <ReactBootStrap.Navbar.Brand><Link style={link} to="/home"><h3 className="font">BOOK LAND</h3></Link></ReactBootStrap.Navbar.Brand>
                ...
                <ReactBootStrap.Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <ReactBootStrap.Nav>
                        ...
                        <ReactBootStrap.NavDropdown style={link} title="ADMIN" id="basic-nav-dropdown">
                         <ReactBootStrap.NavDropdown.Item ><Link style={link} to="/addBook"> <FontAwesomeIcon icon={faPlus} /> Add Book</Link></ReactBootStrap.NavDropdown.Item>
                         <ReactBootStrap.NavDropdown.Item style={link} ><Link style={link} to="/manageBook"> <FontAwesomeIcon icon={faTasks} /> Manage Book</Link></ReactBootStrap.NavDropdown.Item>
